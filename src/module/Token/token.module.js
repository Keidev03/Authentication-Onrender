...
exports.TokenModule = TokenModule = __decorate([
    (0, common_1.Module)({
        imports: [mongoose_1.MongooseModule.forFeature([{ name: token_schema_1.Token.name, schema: token_schema_1.TokenSchema }]), user_module_1.UserModule, (0, common_1.forwardRef)(() => oauth2_module_1.OAuth2Module), client_module_1.ClientModule, session_module_1.SessionModule],
